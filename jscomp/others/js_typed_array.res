...
module ArrayBuffer = {
  ...
  @new @ocaml.doc(" takes length. initializes elements to 0 ")
...
module type S = {
  @@ocaml.text(" Implements functionality common to all the typed arrays ")
  ...
  /* Accessor functions
   */
  @bs.send.pipe(: t) @ocaml.doc(" ES2016 ")
...
module Int8Array = {
  ...
  @bs.send.pipe(: t) @ocaml.doc(" `start` is inclusive, `end_` exclusive ")
